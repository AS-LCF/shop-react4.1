...
const CheckoutPage=({finalPrice,onSubmit})=>{
    ...
    const discountPercetange= discountCode.trim().tuUpperCase()==='SALE2025'?
    0.1 : 0;
    ...
    if(orderSubmitted){
        return(
            <div className="container mx-auto p-4">
                <div className="max-2xl mx-auto p-6 bg-white shadow
                rounded text-center">
    ...
    return(
        <div className="container mx-auto p-4  ">
            <CheckoutForm cartItems={cartItems} finalPrise={finalPrice}
